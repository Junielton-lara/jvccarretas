...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    const message = "Olá! Tenho interesse em uma carreta JVC. Gostaria de mais informações.";
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <div className="bg-black text-white text-sm py-2 px-3 rounded-lg whitespace-nowrap">
